...
from dagster import asset, Config, AssetExecutionContext, MetadataValue, sensor, SensorEvaluationContext, RunRequest, Definitions, SkipReason 
import pandas as pd
import os
...
class MyFilePath(Config):
    ...
    # Use Field to specify a default value and attach metadata
    path: str = Field(
        default="Solution/bike_info.csv", description="The path to the csv parse"
    )
